---
name: github
description: "Interact with GitHub via the gh CLI. Use when the user asks about issues, PRs, CI/workflow runs, or to run gh api; requires gh to be installed (brew/apt)."
